...
nota = int(input("Ingrese a nota de alumno: "))
...
contra = input("Ingrese una contraseña entre 8 y 14 digitos: ")
...
num_x = int(input("Elige una de as siguentes opciones: \n 1. Quiere su nombre en mayúsculas. Por ejemplo: PEDRO.\n 2. Quiere su nombre en minúsculas. Por ejemplo: pedro.\n 3. Quiere su nombre con la primera letra mayúscula. Por ejemplo: Pedro. \n"
))
...
if num_x == 1: 
    ...
    print("El numero ingresado no pertenece a ninguna opción.")
...
terremoto = float(input("Ingrese la magnitud de un terremoto (según la escala de Richter): "))
